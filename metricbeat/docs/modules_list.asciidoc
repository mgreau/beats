...
|<<metricbeat-module-tekton,tekton>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-tekton-pipelines_stats,pipelines_stats>> beta[]  
|<<metricbeat-metricset-tekton-taskruns,taskruns>> beta[]  
...
include::modules/tekton.asciidoc[]
