...
`tekton` contains statistics that were read from Tekton Pipelines controller
...
Tekton Pipelines metrics (TaskRuns, PipelineRuns...)



*`tekton.pipelines_stats.taskrun.count`*::
+
--
Total TaskRuns executed by Tekton
...
*`tekton.pipelines_stats.taskrun.running.count`*::
+
--
Number of TaskRuns currently running
...
*`tekton.pipelines_stats.pipelinerun.count`*::
+
--
Total PipelineRuns executed by Tekton
...
*`tekton.pipelines_stats.pipelinerun.running.count`*::
+
--
Number of PipelineRuns currently running
...
Tekton TaskRuns metrics



*`tekton.taskruns.taskrun.name`*::
+
--
This identifies the TaskRun name.
...
*`tekton.taskruns.taskrun.status`*::
+
--
This identifies the TaskRun status (success, failed).
...
*`tekton.taskruns.taskrun.task`*::
+
--
This identifies the Task related to this Run.
...
*`tekton.taskruns.taskrun.namespace`*::
+
--
This identifies the namespace where the TaskRun is deployed.
...
*`tekton.taskruns.taskrun.duration.sec.bucket.*`*::
+
--
TaskRun duration histogram buckets in seconds
...
*`tekton.taskruns.taskrun.duration.sec.sum`*::
+
--
TaskRun duration, sum of durations in seconds
...
*`tekton.taskruns.taskrun.duration.sec.count`*::
+
--
TaskRun duration, number of requests
